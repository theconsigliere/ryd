...
register_sidebar( array(
    ...
    'description' => __( 'The footer widget, edit socials and contact info.'),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget' => '</div>',
    ...
    register_sidebar( array(
        ...
        'description' => __( 'The Header widget, edit socials and contact info.'),
...
function plate_scripts_and_styles() {
    ...
    if ( !is_admin() ) {
        ...
        wp_enqueue_script( 'plate-nav', get_theme_file_uri() . '/library/js/nav-min.js' );
        wp_enqueue_script( 'plate-barba', get_theme_file_uri() . '/library/js/barba.js' );

       wp_enqueue_script( 'plate-flickity', get_theme_file_uri() . '/library/js/flickity.js' , array( 'jquery' ), '', true );
        wp_enqueue_script( 'plate-barba-script', get_theme_file_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );
...
function plate_theme_support() {
    ...
    register_nav_menus( array(
        ...
        'footer-column' => __( 'Footer Column left', 'platetheme' ), // secondary nav in footer. Uncomment to use or edit.
        'footer-column2' => __( 'Footer Column right', 'platetheme' ) // secondary nav in footer. Uncomment to use or edit.
...
function plate_dashboard_widget_init() {
    ...
    $url = get_admin_url();
    $img = get_theme_file_uri() . '/library/images/ryderslade-logo.png';

    echo '<div class="dashboard-image"><img src=' . $img . '" width="200" height="auto" /></div>';
...
if ( in_array($_SERVER['REMOTE_ADDR'], array('127.0.0.1', '::1')) ) {
    ...
    // add Span to menu-has0children class
    ...
    if('main-nav' == $args->theme_location && $depth === 0 ){
